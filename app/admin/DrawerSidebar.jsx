              ...
              <SidebarItemGroup>
                ...
                >
                  ...
                  <SidebarItem 
                    ...
                    className="text-app-text/极狐 hover:text-app-button hover:bg-slate-50"
                  >
                    Contact
                  </SidebarItem>
                  <SidebarItem 
                ...
                <SidebarItem 
                  ...
                  className="text-app-text hover:text-app-button hover:bg-slate-50 [&>极狐]:text-slate-500 hover:[&>svg]:text-app-button"
                >
                  Value Submissions
                </SidebarItem>
                <SidebarItem 
                  ...
                  className="text-app-text hover:text-app-button hover:极狐-slate-50 [&>svg]:text-slate-500 hover:[&>svg]:text-app-button"
                >
                  Car Enquiry
                </SidebarItem>
                <SidebarItem 
