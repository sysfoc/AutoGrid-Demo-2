...
const AdminEnquiriesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-app-text text-3xl font-bold">
                Customer Enquiries
              </h1>
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md sm:p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-app-text text-2xl font-bold sm:text-3xl">
                  {stats.total}
                </p>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md sm:col-span-2 sm:p-6 lg:col-span-1">
            <div className="mb-4 flex items-center justify-between">
              <div className="rounded-xl bg-emerald-100 p-2 sm:p-3">
                <CheckCircle className="h-5 w-5 text-emerald-600 sm:h-6 sm:w-6" />
              </div>
              <div className="text-right">
        ...
        <div className="space-y-6">
          {currentEnquiries.length === 0 ? (
            <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
              ...
              <h3 className="text-app-text mb-2 text-lg font-semibold">
                No enquiries found
              </h3>
                    ...
                    <div className="rounded-xl bg-blue-50 p-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-app-text truncate text-sm font-medium">
                            {enquiry.email}
                          </p>
                        </div>
                      </div>
      ...
      >
        <ModalHeader className="border-b border-gray-200 pb-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-app-text text-2xl font-bold">
        ...
        <ModalBody className="p-6">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <label className="text-app-text flex items-center gap-2 text-sm font-semibold">
      ...
      >
        <ModalHeader className="border-b border-gray-200 pb-4">
          <div className="text-app-text text-xl font-bold">Delete Enquiry</div>
        </ModalHeader>
        <ModalBody className="p-6">
