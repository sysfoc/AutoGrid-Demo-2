...
const CardetailCard = () => {
  ...
  return (
    <main
      className="car-listings"
      role="main"
      aria-label="Car listings and search results"
    >
      {/* Controls Section */}
      <section className="mb-6" aria-label="Listing controls and filters">
              ...
              >
                ...
                >
                  ...
                  {!isGridView && car.features?.length > 0 && (
                    ...
                    >
                      {car.features.slice(0, 6).map((feature, idx) => (
                        ...
                        >
                          <Check
                            className="h-3 w-3 flex-shrink-0 text-[var(--primary)]"
                            aria-hidden="true"
                          />
                          {feature}
                        </li>
                  ...
                  <div className="mb-3 flex flex-wrap items-start gap-2">
                    <span
                      className="rounded bg-[var(--primary)] px-2 py-1 text-xs font-medium text-[var(--text-inverse)] dark:text-gray-100"
                      aria-label={`Year: ${car.year || car.modelYear || "Unknown"}`}
                    >
                      {car.year || car.modelYear || ""}
                    </span>
                    <div className="flex min-w-0 flex-col text-sm text-[var(--text-secondary)] md:flex-[0.8]">
                      {[
                        !isGridView &&
                          (() => {
                    ...
                    {!isGridView && (
                      <div className="w-full text-sm text-[var(--text-secondary)] sm:w-auto sm:flex-shrink-0">
                        <span className="text-sm text-[var(--text-secondary)]">
                  ...
                  <footer className="mt-auto">
                    <button
                      ...
                      className={`w-fit rounded-lg bg-[var(--primary)] px-3 font-medium text-[var(--text-inverse)] transition-colors hover:bg-[var(--primary-hover)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2 dark:text-gray-100 ${
          ...
          <form onSubmit={handleEnquirySubmit} className="space-y-6" noValidate>
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div id="submit-help" className="sr-only">
                Submit form to send your enquiry. We will respond within 24
                hours.
              </div>
            </div>
          </form>
