...
export default function SellMyCar() {
  ...
  const guides = [
    {
      icon: <Car className="text-4xl text-primary" />,
    ...
    {
      icon: <TrendingUp className="text-4xl text-primary" />,
    ...
    {
      icon: <AlertTriangle className="text-4xl text-primary" />,
  ...
  return (
    <div className="mt-16 min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
          <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2">
            <div className="space-y-8">
              <div className="inline-flex items-center rounded-full bg-primary/10 px-4 py-2 backdrop-blur-sm">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="group relative inline-flex transform items-center justify-center overflow-hidden rounded-xl bg-primary px-8 py-4 text-lg font-semibold text-white shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800"
                >
                  <div className="absolute inset-0 bg-primary-hover opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 sm:grid-cols-4">
              {benefits.map((benefit, index) => (
                <div key={index} className="text-center">
                  <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full bg-primary/20 text-primary backdrop-blur-sm">
                    {benefit.icon}
                  </div>
      ...
      <section className="bg-background-secondary py-20 dark:bg-gray-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-4xl font-bold text-text dark:text-white">
              How Our Service Works
            </h2>
            <p className="mx-auto max-w-3xl text-xl text-text-secondary dark:text-gray-300">
            ...
            {howItWorks.map((step, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl dark:bg-gray-900">
                  <div className="absolute left-0 top-0 h-1 w-full bg-gradient-to-r from-primary to-blue-500"></div>
                  <div className="mb-6 flex items-center justify-between">
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-r from-primary to-blue-500 text-white shadow-lg">
                      {step.icon}
                    </div>
                  ...
                  <h3 className="mb-4 text-2xl font-bold text-text dark:text-white">
                    {step.title}
                  </h3>
                  <p className="mb-4 leading-relaxed text-text-secondary dark:text-gray-300">
                    {step.description}
                  </p>
                  <div
                ...
                {index < howItWorks.length - 1 && (
                  <div className="absolute -right-4 top-1/2 z-10 hidden -translate-y-1/2 transform md:block">
                    <ArrowRight className="text-2xl text-primary/50" />
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {features.map((feature, index) => (
              <div key={index} className="group text-center">
                <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-r from-primary to-blue-500 text-white shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl">
                  {feature.icon}
                </div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="flex w-full items-center justify-between p-6 text-left transition-colors duration-300 hover:bg-background-secondary dark:hover:bg-gray-700"
                >
                  <span className="pr-4 text-lg font-semibold text-text dark:text-white">
                    {faq.question}
                  </span>
                  <ChevronDown
                    className={`h-5 w-5 text-primary transition-transform duration-300 dark:text-blue-400 ${
                ...
                >
                  <div className="px-6 pb-6">
                    <div className="mb-4 h-px bg-gradient-to-r from-primary to-blue-500"></div>
                    <p className="leading-relaxed text-text-secondary dark:text-gray-300">
                      {faq.answer}
                    </p>
                  </div>
                </div>
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-primary to-blue-600 py-20 dark:from-gray-800 dark:to-gray-900">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
            <button
              onClick={handleContactUs}
              className="group flex items-center justify-center rounded-xl border border-transparent bg-gradient-to-r from-primary to-blue-500 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:from-primary-hover hover:to-blue-500"
            >
              Contact Our Experts
